...
class Game(object):
    ...
    def Gameover(self):
        return len(self.Get_Valid_Pos(self.black_chess, self.white_chess)) == 0 and \
               len(self.Get_Valid_Pos(self.white_chess, self.black_chess)) == 0\
            , len(self.black_chess) - len(self.white_chess)
